#!/usr/bin/env python3
"""Exact, classical validation for the cached LiH qubit Hamiltonian.

Both LiH active spaces this workflow offers -- CASCI(2e,5o) at 10 qubits and
the full STO-3G space at 12 qubits -- are small enough to diagonalize exactly,
so every claim the VQE makes is checked against a number that is simply correct
