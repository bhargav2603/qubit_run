...
Backend-independent: this module knows nothing about Qiskit, and is kept
byte-comparable with `../imipramine_cas6e6o/hamiltonian.py` apart from this
docstring and the two comments that name the simulator. Imipramine is the same
molecule whichever simulator runs it, and the two studies are only comparable
while the chemistry layer is identical.
